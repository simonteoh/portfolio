	...
	<div class="fusion-builder-live-toolbar fusion-top-frame">
		<ul class="fusion-toolbar-nav">
			<li class="fusion-branding">
				<?php $version = defined( 'AVADA_VERSION' ) ? AVADA_VERSION : FUSION_BUILDER_VERSION; ?>
				<div class="fusion-builder-logo-wrapper has-tooltip" aria-label="<?php echo esc_attr( 'v' . $version ); ?>">
