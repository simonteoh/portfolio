		...
		public function attr() {
			...
			if ( $container_args ) {
				if ( $this->args['flex'] ) {
					...
					$width               = 'yes' === $container_args['hundred_percent'] || 'fusion_builder_row_inner' === $this->shortcode_name ? '100%' : $fusion_settings->get( 'site_width' );
					...
					if ( 'no' === $container_args['hundred_percent'] && 'fusion_builder_row_inner' !== $this->shortcode_name ) {
