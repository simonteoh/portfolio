			...
			<div class="intro-text">
				<p>
					...
					printf(
						...
						esc_html__( 'Use the %1$s to replace %2$s on every page of your site, or create a new %3$s to replace them on specific pages, based on the conditions you choose.', 'fusion-builder' ),
		...
		<div class="fusion-builder-important-notice fusion-template-builder avada-db-card avada-db-card-first">
			<div class="intro-text">
				...
				<div class="avada-db-card-notice">
					...
					<?php
					printf(
						/* translators: %s: "layout Sections Documentation Link". */
						esc_html__( 'Please see the %s.', 'fusion-builder' ),
						'<a href="https://theme-fusion.com/documentation/fusion-builder/theme-builder/" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Layout Sections Documentation', 'fusion-builder' ) . '</a>'
					);
					?>
					</p>
				</div>
