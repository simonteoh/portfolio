			...
			<div class="intro-text">
				...
				<div class="avada-db-card-notice">
					...
					<p class="avada-db-card-notice-heading">
						<?php
						printf(
							/* translators: %s: "layout Builder Documentation Link". */
							esc_html__( 'Please see the %s.', 'fusion-builder' ),
							'<a href="https://theme-fusion.com/documentation/fusion-builder/theme-builder/" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Layout Builder Documentation', 'fusion-builder' ) . '</a>'
						);
						?>
					</p>
				</div>
