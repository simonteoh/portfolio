			...
			<div class="avada-db-card-notice">
				...
				<p class="avada-db-card-notice-heading">
					...
					printf(
						...
						esc_html__( 'To change gobal stylings of the Avada Builder elements, please go to the %s.', 'fusion-builder' ),
						'<a href="' . esc_url( admin_url( 'themes.php?page=avada_options#alert_shortcode_section_start_accordion' ) ) . '" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Element Global Options Options', 'fusion-builder' ) . '</a>'
					);
					?>
				</p>
			</div>
