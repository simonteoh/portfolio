	...
	if ( ! class_exists( 'FusionSC_Menu' ) ) {
		...
		class FusionSC_Menu extends Fusion_Element {
			...
			protected function get_styles() {
				$this->base_selector = '.fusion-menu-element-wrapper[data-count="' . $this->count . '"]';
				$this->dynamic_css   = [];
				...
				if ( ! $this->is_default( 'sticky_min_height' ) ) {
					$this->add_css_property( '.fusion-sticky-container.fusion-sticky-transition ' . $this->base_selector . ' .fusion-menu-element-list', 'min-height', $this->args['sticky_min_height'] );
				}
