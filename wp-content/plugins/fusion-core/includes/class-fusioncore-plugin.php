		...
		<div class="fusion-dbw-wrapper">
			<div class="fusion-dbw-header">
				<div class="fusion-dbw-logo">
					...
					<span class="fusion-dbw-version">v<?php echo defined( 'AVADA_VERSION' ) ? esc_html( AVADA_VERSION ) : ''; ?></span>
				</div>
				<a href="<?php echo esc_url( 'https://1.envato.market/E7kX9' ); ?>" target="_blank" class="fusion-dbw-license button button-primary"><?php esc_html_e( 'Get Another License', 'fusion-core' ); ?></a>
			</div>
